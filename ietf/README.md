...
Run `make -C ietf render-support` to publish schemas, descriptive examples, guides, Problem Type
pages, and test vectors into `docs/`. The full check rejects missing, unexpected, or stale published
support artifacts and rejects disagreement between Problem Details vectors and the normative
problem-code table.
