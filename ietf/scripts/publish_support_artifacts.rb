...
abort "usage: publish_support_artifacts.rb [--check] [all|conformance|examples|guides|problems|schemas|test-vectors]" unless
  %w[all conformance examples guides problems schemas test-vectors].include?(section) && ARGV.empty?
...
sections = {
  ...
  "guides" => lambda {
    file_tree_artifacts(
      IETF_ROOT.join("guides"),
      "ODP Implementation Guides",
      "Non-normative guidance for Offering Discovery Protocol implementers and Internet-Draft authors."
    )
  },
